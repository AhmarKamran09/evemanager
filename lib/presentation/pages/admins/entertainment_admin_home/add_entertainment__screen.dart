...
class _AddEntertainmentScreenState extends State<AddEntertainmentScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<EntertainmentCubit, EntertainmentState>(listener: (context, state) {
      if (name.text.isNotEmpty) {
        if (state is EntertainmentSuccessForOwner) {
          DisplayToast('Entertainment Added Successfully');
      ...
      body: ListView(
        children: [
          ...
          MyTextField(
            fieldvalue: name,
            label: "Name",
            hint: "Enter Entertainment name",
          ),
          MyTextField(
              fieldvalue: address,
              label: "Address",
              hint: "Enter Entertainment address"),
          MyTextField(
            fieldvalue: city,
            label: "City",
            hint: "Enter Entertainment City",
          ),
          MyTextField(
              fieldvalue: contact,
              label: "Contact",
              hint: "Enter Entertainment contact number"),
          MyTextField(
            fieldvalue: description,
            label: "Description",
            hint: "Enter Entertainment description",
          ),
          ListView.builder(
            shrinkWrap: true,
          ...
          TextButton(
            onPressed: () {
              _addEntertainment(context, uid);
            },
            child: Text('Add Entertainment'),
          ),
        ],
      ),
    );
  ...
  void _addEntertainment(BuildContext context, String? uidvalue) async {
    if (name.text.isNotEmpty &&
      ...
      await BlocProvider.of<EntertainmentCubit>(context).AddEntertainment(EntertainmentEntity(
        owner_id: uidvalue,
